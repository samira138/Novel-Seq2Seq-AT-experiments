...
class DataPrepare:
    ...
    def __repr__(self):
        return f"The dataset of {self.datafile}，which with the lengh of {self.input_steps} in input seqlences"
    ...
    def _split_data(self, reframed_data):
        ...
        param:
            reframed_data: [DataFrame] with the shape of [sample_num, input_steps *3  + pred_horizion]
